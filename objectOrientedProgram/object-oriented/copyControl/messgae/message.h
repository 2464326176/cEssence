/*
 * @Author: yh
 * @Date: 2022/9/13 23:19
 * @Description: 
 * @FilePath: message.h
 */

#ifndef CESSENCE_OBJECTORIENTEDPROGRAM_OBJECT_ORIENTED_COPYCONTROL_MESSAGE_H
#define CESSENCE_OBJECTORIENTEDPROGRAM_OBJECT_ORIENTED_COPYCONTROL_MESSAGE_H
#include <string>
#include <iostream>
#include <set>
using namespace std;
...
#endif //CESSENCE_OBJECTORIENTEDPROGRAM_OBJECT_ORIENTED_COPYCONTROL_MESSAGE_H
