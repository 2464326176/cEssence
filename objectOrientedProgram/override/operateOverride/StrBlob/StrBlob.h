...
#ifndef OPERATE_OVERRIDE_STRBLOB_H_
#define OPERATE_OVERRIDE_STRBLOB_H_
...
inline const string *ConstStrBlobPtr::operator->() const { return &this->operator*(); }
...
#endif // OPERATE_OVERRIDE_STRBLOB_H_
